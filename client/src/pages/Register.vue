<template>
    ...
    <div class="register">
        ...
        <form @submit="handleSubmit" novalidate autocapitalize="off">
            ...
            <br>
            <input type="text" id="firstname" class="sub" name="firstname" placeholder="Enter your first name" v-model="form.firstname"
                   required>
            ...
            <input type="text" id="lastname" name="lastname" class="sub" placeholder="Enter your last name" v-model="form.lastname"
                   required>
            <p class="error" v-if="errorObj.lastnameError.length > 0">{{ errorObj.lastnameError[0] }}</p>
            <label for="email" class="info">Email: <br/> </label>
            <input type="email" id="email" name="email" class="sub" placeholder="Enter email" v-model="form.email" required>
            ...
            <input type="text" id="username" class="sub" name="username" placeholder="Enter username" v-model="form.username" required>
            ...
            <input type="password" id="password" class="sub" name="password" placeholder="Enter password" v-model="form.password"
                   required>
            ...
            <input type="text" class="sub" id="phone" name="phone" placeholder="0987654321" v-model="form.phone" required>
            ...
            <input type="date" class="sub" id="birth" name="birth" v-model="form.birth" required>
