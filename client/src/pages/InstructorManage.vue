<template>
    ...
    <div class="tab">
        ...
        <button class="tablinks" v-on:click="openPayment(1)">Create New Course</button>
    </div>
    ...
    export default {
        ...
        methods: {
            ...
            addCourse() {
                axios.post('/instructor/create', this.course, {withCredentials: true})
                .then(res=>{
                    alert(res.data.msg);
                    location.reload();
                });
